...
// required string mobile = 1;
	...
	inline void mobile_request::clear_mobile() {
		mobile_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
	...
	inline void mobile_request::_internal_set_mobile(const std::string& value) {
		_has_bits_[0] |= 0x00000001u;
		mobile_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
	}
	...
	inline void mobile_request::set_mobile(const char* value) {
		...
		_has_bits_[0] |= 0x00000001u;
		mobile_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
			GetArena());
	...
	inline void mobile_request::set_mobile(const char* value,
		size_t size) {
		_has_bits_[0] |= 0x00000001u;
		mobile_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
	...
	inline std::string* mobile_request::_internal_mutable_mobile() {
		_has_bits_[0] |= 0x00000001u;
		return mobile_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
	}
