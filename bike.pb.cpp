...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_list_account_records_response_bike_2eproto =
	...
	static bool dynamic_init_dummy_bike_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_bike_2eproto)), true);
	namespace tutorial {
		...
		mobile_request::mobile_request(const mobile_request& from)
			...
			if (from._internal_has_mobile()) {
				mobile_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), from._internal_mobile(),
					GetArena());
			}
